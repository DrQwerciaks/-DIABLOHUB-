...
RegisterServerEvent('krs:reward', function()
  local xPlayer = ESX.GetPlayerFromId(source)
  xxx = math.random(1,5)
  xPlayer.showNotification("Zebrałeś "..xxx.." marichuany")
  xPlayer.addInventoryItem('weed_pooch', xxx)
end)
  ...
  if plant.Gender == "Male" then
    ...
    if r < 3000 then
      if plant.Quality > 95 then
        xPlayer.addInventoryItem('nawoz', math.floor( math.random( math.floor(plant.Quality/2), math.floor(plant.Quality*1.5))/10))
      elseif plant.Quality > 80 then
        xPlayer.addInventoryItem('nawoz', math.floor( math.random( math.floor(plant.Quality/2), math.floor(plant.Quality*1.5))/20)) 
      else
...
-- Maintenance Items
ESX.RegisterUsableItem('butelkawody', function(source)
  local xPlayer = ESX.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); ESX.GetPlayerFromId(source); end
  if xPlayer.getInventoryItem('butelkawody').count > 0 then 
    xPlayer.removeInventoryItem('butelkawody', 1)
...
ESX.RegisterUsableItem('nawoz', function(source)
  local xPlayer = ESX.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); ESX.GetPlayerFromId(source); end
  if xPlayer.getInventoryItem('nawoz').count > 0 then 
    xPlayer.removeInventoryItem('nawoz', 1)
...
ESX.RegisterUsableItem('lowgrademaleseed', function(source)
  local xPlayer = ESX.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); ESX.GetPlayerFromId(source); end
  if xPlayer.getInventoryItem('lowgrademaleseed').count > 0 and xPlayer.getInventoryItem('doniczka').count > 0 then 
    xPlayer.removeInventoryItem('lowgrademaleseed', 1)
    xPlayer.removeInventoryItem('doniczka', 1)
...
ESX.RegisterUsableItem('dziwneliscie', function(source)
  local xPlayer = ESX.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); ESX.GetPlayerFromId(source); end
  if xPlayer.getInventoryItem('dziwneliscie').count > 0 and xPlayer.getInventoryItem('doniczka').count > 0 then
    xPlayer.removeInventoryItem('dziwneliscie', 1)
    xPlayer.removeInventoryItem('doniczka', 1)
...
ESX.RegisterUsableItem('lowgradefemaleseed', function(source)
  local xPlayer = ESX.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); ESX.GetPlayerFromId(source); end
  if xPlayer.getInventoryItem('lowgradefemaleseed').count > 0 and xPlayer.getInventoryItem('doniczka').count > 0 then
