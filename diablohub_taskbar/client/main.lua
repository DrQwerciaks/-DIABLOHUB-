            ...
            Citizen.CreateThread(function ()
                while isDoingAction do
                    ...
                    if IsControlJustPressed(0, 73) and mythic_action.canCancel then
                        TriggerEvent("need_taskbar:cancel")
                    end
...
RegisterNetEvent("need_taskbar:progress")
AddEventHandler("need_taskbar:progress", Progress)

RegisterNetEvent("need_taskbar:ProgressWithStartEvent")
AddEventHandler("need_taskbar:ProgressWithStartEvent", function(action, start, finish)
    ProgressWithStartEvent(action, start, finish)
end)

RegisterNetEvent("need_taskbar:ProgressWithTickEvent")
AddEventHandler("need_taskbar:ProgressWithTickEvent", function(action, tick, finish)
    ProgressWithTickEvent(action, tick, finish)
end)

RegisterNetEvent("need_taskbar:ProgressWithStartAndTick")
AddEventHandler("need_taskbar:ProgressWithStartAndTick", function(action, start, tick, finish)
    ProgressWithStartAndTick(action, start, tick, finish)
end)

RegisterNetEvent("need_taskbar:cancel")
AddEventHandler("need_taskbar:cancel", function()
    isDoingAction = false
    wasCancelled = true

    TriggerEvent("need_taskbar:actionCleanup")
...
RegisterNetEvent("need_taskbar:actionCleanup")
AddEventHandler("need_taskbar:actionCleanup", function()
